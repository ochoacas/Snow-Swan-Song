/*
 * L.TimeDimension.Layer.TileLayer.CUSTOM: Custom Leaflet TimeDimension TileLayer
 */

time_shown = new Date('2100-01-01T00:00:00');
...
L.TimeDimension.Layer.TileLayer.CUSTOM = L.TimeDimension.Layer.TileLayer.extend({
...
//        var startDate = new Date();
        var startDate = time_shown;
//        var startDate = new Date('1981-01-01');  // BK edit -- start with beginning of time series
...
L.timeDimension.layer.tileLayer.custom = function(layer, options) {
    return new L.TimeDimension.Layer.TileLayer.CUSTOM(layer, options);
};